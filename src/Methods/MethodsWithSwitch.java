...
public class MethodsWithSwitch {
    ...
    public static void main(String[] args) {
        ...
        // years of service first and then salary
...
//
    ...
    //write a method that return domestic for domestic animals
    //and wild for wild animals
    //take animal as String
    public static String getAnimalKind(String animalType) {
        switch (animalType.toLowerCase()) { // all of the bottom are string
            case "cat":
            case "chicken":
            case "horse":
            case "dog":
...
// work with 6-8 cases then say unknow animal
    ...
    public static void test() {
        ...
        int num = sc.nextInt(); //next int is a method
    }
