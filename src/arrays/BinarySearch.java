...
public class BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        //[30,41,41, 45, 47, 51, 53, 54, 58, 60, 73,78]
        //0-1
        //-15-1
        //
        ...
        //return an int which represnets the index of a found element
       int index = Arrays.binarySearch(messiGoalsInLastDecadePerYear, 37);
        int index2 = Arrays.binarySearch(messiGoalsInLastDecadePerYear, 54); // can put any number
        ...
        //binarySearch method is going to return an index where the element would be placed
        //in a sorted array -1.
    ...
    //method takes an array and it takes a int value
    // your method should return an int which is the index fo the given value
