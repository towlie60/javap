...
public class MultiDimesionalArrays {
    ...
    public static void main(String[] args) {
        ...
        //declaring inner array size doesnt define a min or max values you can store.
...
//        weeklySales[4] = new double[4]; // null bc its an object
//        weeklySales[5] = new double[4];
//        weeklySales[6] = new double[4];

        System.out.println(Arrays.deepToString(weeklySales));
        System.out.println(weeklySales[1][2]); // need to have two brackets


        //calculate total amount of sales of the week.

        for (int i = 0; i < weeklySales.length; i++) { // need to use nested loops
            for (int y = 0; y < weeklySales[i].length; y++) { // has to be another length
