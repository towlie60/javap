...
public class ArraysIntro {
    ...
    public static void main(String[] args) {
        //As a representitive of a education department
        ...
        //able to access and use them in any way you want.
        ...
        //it's allowed to use variable to access array values at given
        //index
        ...
        //it will always give you the dataOf Array elements.
       // studentRaces[8] = > you treat this variable (element)
        ...
        for (int i = 0; i < 10; i++) {
            ...
            int counter = 0;
            //count each race and print out how many students of each race we do
        ...
        System.out.println();
           ...
           //we must store onlu same type of information either all ages or all weights
        ...
        results[1] = "J.B";
       // results[2] = "J.B";
     //   results[3] = "J.B"; //throw IndexOutofBound Exception.
