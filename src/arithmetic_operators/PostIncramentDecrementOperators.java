...
public class PostIncramentDecrementOperators {
    ...
    public static void main(String[] args) {
       ...
       // num1++; // num1+=1; num1 = num1+1;
        ...
        // in the sane place rather in the next usage of numbOfPeople
        ...
        System.out.println("pre increment" + --x); //updates right away thus 9
        System.out.println("post decrement" + a++); // stay the same on this line 10
        System.out.println("post decrement" + b--); // stay the same on this line 10
