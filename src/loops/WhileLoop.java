...
//        } ==> will enter infinite loop
        ...
        //Not going to run at all bc the condtion was false
        ...
        while (counter5 < 12) {  //don't update the counter
            //int sum = 0; => dangerous, bc before every iteration
            //sum will be reinitialized to 0
            counter5++;  // ++ increase by 1 , counter 5 =0 then incremented, sum = 0 +
        ...
        //ask to enter 10 exam scores
        //and print out the average score

        //first ask the user how many score you want to enter
        //10
        //ex: Enter Score 1
        //100
