...
public class NestedLoops {
    ...
    public static void main(String[] args) {
        ...
        for (int a = 5; a <= 6; a++) {
            ...
            //How many numbers I need to create a table for?
            // How many times I need to execute certain statement?
            // the multiplication of number of iteration of a ouer loop and inner loop will be the number
