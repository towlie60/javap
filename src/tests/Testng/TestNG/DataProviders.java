...
public class DataProviders {
    ...
    //set of data
    //we use DataProviders for functionalities that require not more than 10 fields(piece of info)
    //if more than 10 we use external file like xml. Apache POI -> java library to read and write
    ...
    public static Object[][] accountData() {
        return new Object[][]{
                ...
                {"Jane Doe", "122343 main st", "312-730-2097", 11},
//                {"Alex Pato", "123 main st","312-730-2097",19},
//                {"Alex Pato", "123 main st","312-730-2097",19},
        };
    }
