...
public class DirectoryApp {
    ...
    public static void main(String[] args) {
      ...
      Security jetLee = new Security("Jet Lee", "02/11/1950" , "Security", 12343434.00);
        ...
        Employee employee1 =
                new Security("Jet Lee", "02/11/1950" , "Security", 12343434.00);

      //  Engineer e = new Security("Jet Lee", "02/11/1950" , "Security", 12343434.00);
